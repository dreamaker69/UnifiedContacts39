...
With Unified Contacts you can search for contacts in your personal Outlook contacts (Exchange Online is required) and simultaneously in the corporate address book Azure AD. Additionally, Unified Contacts Pro automatically searches your [SharePoint Online](https://github.com/Unified-Contacts/unified-contacts-net/wiki/advanced-configuration/sharepoint-online-lists.md) environment for compatible list types (contact-type), allowing you to build tools (e.g. through an Azure Logic App or Microsoft Power App) to sync contacts from external databases and CRM systems into a standardized format, that Unified Contacts Pro can read. Last but not least, Unified Contacts Pro provides a powerful [Database](https://github.com/Unified-Contacts/unified-contacts-net/wiki/advanced-configuration/uc-database/) which you can fill with contacts from anywhere, either leveraging our [REST API](https://github.com/Unified-Contacts/unified-contacts-net/wiki/advanced-configuration/uc-database/crud-operations-with-rest-api.md) or data integration services such as [Azure Data Factory (ADF)](https://github.com/Unified-Contacts/unified-contacts-net/wiki/advanced-configuration/uc-database/sync-data-with-azure-data-factory.md). The search results will be displayed in a comprehensive, interactive and coherent format across all your contact sources.
